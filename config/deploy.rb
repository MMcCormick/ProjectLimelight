...
set :default_environment, {
    ...
    'GEM_HOME'     => '/usr/local/rvm/gems/ruby-1.9.3-p392@Limelight',
    'GEM_PATH'     => '/usr/local/rvm/gems/ruby-1.9.3-p392:/usr/local/rvm/gems/ruby-1.9.3-p392@global:/usr/local/rvm/gems/ruby-1.9.3-p392@Limelight',
    'BUNDLE_PATH'  => '/usr/local/rvm/gems/ruby-1.9.3-p392@Limelight'  # If you are using bundler.
}
