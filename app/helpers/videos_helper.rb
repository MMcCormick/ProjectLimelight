module VideosHelper
  ...
  def video_embed(video, w, h)
    case video.provider_name
      when 'YouTube'
        "<iframe class='video-embed' width='#{w}' height='#{h}' src='http://www.youtube.com/embed/#{video.provider_video_id}?wmode=transparent' frameborder='0' allowfullscreen></iframe>".html_safe
      when 'Vimeo'
