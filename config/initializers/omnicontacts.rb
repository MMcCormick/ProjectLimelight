...
Rails.application.middleware.use OmniContacts::Builder do
  importer :gmail, ENV["GOOGLE_KEY"] || "878681641011-539hes1hlj5t55qte7hmg9jk6113va14.apps.googleusercontent.com", ENV["GOOGLE_SECRET"] || "RRXSZ7AWo9By3CYENka3RsEj", {:redirect_path => "/contacts/gmail/callback"}
