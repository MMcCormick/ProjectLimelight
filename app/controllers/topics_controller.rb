class TopicsController < ApplicationController
  ...
  def show
    ...
    @og_tags = build_og_tags(@title, og_namespace+":topic", topic_url(@this), @this.image_url(:fit, :large), @description, {"#{og_namespace}:followers_count" => @this.followers_count.to_i, "#{og_namespace}:score" => @this.score.to_i, "#{og_namespace}:type" => @this.primary_type ? @this.primary_type : ''})
