$(function() {
    ...
    $('.list-createB').colorbox({title:"Create a New List", transition: "none", opacity: .5, href: function() {return $(this).attr('href') + '.ajax'}});
    ...
    $('.comment .reply_show').live('click', function() {
        ...
        var $reply = $('.comment_reply').clone()
            ...
            .find('.comment_reply_cancel').click(function() {
                $reply.remove();
            }).end()
    ...
    $('body').mousemove(function() { $(this).removeClass('shortcut-on') })
